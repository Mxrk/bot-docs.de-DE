...
Wenn Sie bereit sind, können Sie die Quellen zurück in Azure veröffentlichen. [Führen Sie diese Schritte aus, um zu erfahren, wie Sie den Bot zurück in Azure veröffentlichen.](../bot-service-build-download-source-code.md#publish-node-bot-source-code-to-azure)
