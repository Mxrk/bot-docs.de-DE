...
description: Hier erfahren Sie, wie Sie mithilfe des Bot Framework SDK für .NET mit dem JSON-Schema und FormFlow ein Formular definieren.
author: RobStand
ms.author: kamrani
manager: kamrani
ms.topic: article
