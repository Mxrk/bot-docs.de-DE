...
description: Hier erfahren Sie, wie Sie mit dem Bot Framework SDK für .NET und dem Bot Builder-RealTimeMediaCalling SDK für .NET einen Bot erstellen, der Audio-/Videoanrufe in Echtzeit durchführt.
author: MalarGit
ms.author: malarch
manager: kamrani
ms.topic: article
